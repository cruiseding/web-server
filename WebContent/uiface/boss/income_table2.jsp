...
<div class="page-container">
	  <div class="mt-20">
			...
			<!--   <span id="sum1">总收入（悦币）:${reList[0].sum}</span> -->
...
function fresh_page(pageIndex) {
	...
	$.ajax({
		...
		url:"<%=path%>/ar?p0=A-boss-search&p1=income_table_search&p2="+pageIndex+"&p3=tojson&p4=&p5=${param.p5}&p6="+searchtxtnc+"&p7="+startdate+"&p8="+enddate+"&p9="+pp+"&p10="+income_type,
