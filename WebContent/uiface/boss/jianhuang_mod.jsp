...
<body>
	<article class="page-container">
		<form 
			class="form form-horizontal" id="form-article-add" name="ThisForm">  <%-- action="<%=path%>/ar?a=A-boss-mod&b=cash_mod" method="post" --%>
		
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">鉴黄设置:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['take_time']}" placeholder="请输入内容" 
			...
			<%-- <div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['cash_fee']}" placeholder="请输入内容" 
...
function go(){
	...
	$.ajax({
		type:'POST',
		url: '<%=path%>/ar?a=A-boss-mod&b=jianhuang_xiugai',
