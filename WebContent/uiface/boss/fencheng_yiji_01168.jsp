...
<nav class="breadcrumb">
	...
	<span class="c-gray en">&gt;</span> 分销管理 
	<span class="c-gray en">&gt;</span> 分销列表
	<span class="c-gray en">&gt;</span> 一级下属管理
...
function fresh_page(pageIndex){
	...
	$.ajax({
		...
		url: "<%=path%>/anran?p0=A-boss-search&p1=fencheng_yiji&p2="+pageIndex+"&p3=tojson&p4=${map['user_id']}" ,
