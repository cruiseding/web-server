...
<body>
	<article class="page-container">
		<form 
			class="form form-horizontal" id="form-article-add" name="ThisForm"><%-- action="<%=path%>/ar?a=A-boss-mod&b=service_xiugai&c=${reList[0]['id']}" method="post" --%>
			<input type="text" class="input-text"
						value="${reList[0]['id']}"
						id="abc" name="abc" style="display:none">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">客服微信:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['weixin']}" placeholder="请输入内容" 
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['tel']}" placeholder="请输入内容" 
...
function go(){
	$.ajax({
		type:'POST',
		url: '<%=path%>/ar?a=A-boss-mod&b=service_xiugai',
		data:{abc:$("#abc").val(),onefee:$("#onefee").val(),twofee:$("#twofee").val()},
