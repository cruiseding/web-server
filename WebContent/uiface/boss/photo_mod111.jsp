...
<body>
	<article class="page-container">
		<form action="<%=path%>/ar?a=A-boss-mod&b=photo_mod" method="post"
				...
				<div class="formControls col-xs-8 col-sm-9">
					<div class="uploader-thum-container">
						...
						<input type="file" id="fileimg" /><input type="hidden"
							name="imgname" id="imges" value="${reList[0]['carousel_photo']}" />
			...
			<!-- <div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">是否可进入:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<select id="ss" name="ss2" form="form-article-add">
						<option value="可进入">可进入</option>
						<option value="不可进入">不可进入</option>
					</select>
				</div>
			</div> -->
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">轮播图内容:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['chained_address']}" placeholder="轮播图内容"
