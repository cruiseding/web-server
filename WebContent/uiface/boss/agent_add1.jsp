...
<body>
	<article class="page-container">
		<form 
			class="form form-horizontal" id="form-article-add" name="ThisForm"><%-- action="<%=path%>/ar?a=A-boss-add&b=agent_add1" method="post" --%>
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">女神提现分成:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						 placeholder="请输入内容" 
			...
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button  class="btn btn-primary radius"  onclick="go()" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并提交</button>
	...
	<script type="text/javascript"
		src="<%=path%>/lib/jquery/1.9.1/jquery.js"></script>
	<script type="text/javascript"
...
function go(){
	...
	$.ajax({
		type:'POST',			
		url: '<%=path%>/ar?a=A-boss-add&b=agent_add1',
		data:{changeprice1:$("#changeprice1").val(),changeprice2:$("#changeprice2").val(),changeprice3:$("#changeprice3").val(),changeprice4:$("#changeprice4").val(),changeprice5:$("#changeprice5").val(),changeprice6:$("#changeprice6").val(),changeprice7:$("#changeprice7").val(),changeprice8:$("#changeprice8").val(),changeprice9:$("#changeprice9").val()},
