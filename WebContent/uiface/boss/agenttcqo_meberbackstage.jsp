...
<div class="page-container">
	<div class="text-c">
		<div class="mt-20">
			...
			<span id="sum1"  style="float: left;" >总人数:${pageNo[1]}人</span>
		</div>
...
function fresh_page(pageIndex){
	...
	$.ajax({
		cache: true,
		type: "POST",
		url: "<%=path%>/agent?p0=A-boss-search&p1=amemberbackstage&p2="+pageIndex+"&p3="+startdate+"&p4="+enddate+"&p5=tojson&p6="+pp+"&p7=${param.p7}" ,
		async: true,
