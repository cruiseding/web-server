...
<body>
	<article class="page-container">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">增加金额:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
...
function baocun(){
	...
	/* alert(abc);
	alert(bbb); */
	 layer.confirm('确认要增加'+b+'趣豆？',function(index){ 
	 $.ajax({ 
		url :"<%=path%>/ar?p0=A-boss-mod&p1=qd_mod_a&p2="+a+"&p3="+b+"&p4="+abc+"&p5=&p6=", 
		type : 'post', 
		cache : false, 
		contentType : false, 
		processData : false, 
