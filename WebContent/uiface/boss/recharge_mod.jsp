...
<body>
	<article class="page-container">
		<form 
			class="form form-horizontal" id="form-article-add" name="ThisForm"> <%-- action="<%=path%>/ar?a=A-boss-mod&b=recharge_mod1" method="post" --%>
		<div class="row cl">
...
function go(){
	...
	$.ajax({
		type:'POST',
		url: '<%=path%>/ar?a=A-boss-mod&b=recharge_mod1',
		data:{myid:$("#myid").val(),num:$("#num").val(),num1:$("#num1").val(),changeprice:$("#changeprice").val()},
		success: function(data){
