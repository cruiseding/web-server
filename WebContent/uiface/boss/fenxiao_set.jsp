...
<body>
	<nav class="breadcrumb">
		...
		设置
		<span class="c-gray en">&gt;</span> 分销设置
		...
		<div class="mt-20">
			<div class="dataTables_wrapper">
				<table
					...
					<tr class="text-c">
					<th width="30">序号</th>
				   	<th width="30">分销奖励金额(邀请男用户)</th> 
					<th width="30">vip充值提成</th>
					<th width="30">趣豆充值提成</th>
					<th width="30">分销收入提成</th> 
					<!-- <th width="30">图片收入提成</th> --> 
					<th width="40">操作</th>
					</tr>
					</thead>
					<tbody id="list-content">
							<tr class="text-c">
								<td>1</td>
								 <td>${reList[0]['mon_onefee']}</td>
								 <td>${reList[0]['pay_v_onefee']}</td>
								 <td>${reList[0]['pay_onefee']}</td>
								 <td>${reList[0]['cash_onefee']}</td>
								 <%-- <td>${reList[0]['photo_onefee']}</td> --%>
								<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/ar?p0=A-boss-search&p1=fenxiao_search_mod','','600','510')"
