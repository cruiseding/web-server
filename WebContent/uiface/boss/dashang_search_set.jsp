...
<body>
	<article class="page-container">
		<form  
			class="form form-horizontal" id="form-article-add" name="ThisForm"> <%--  action="<%=path%>/ar?a=A-boss-mod&b=dashang_search_bianji&p2=${reList[0]['id']}" method="post" --%>
			
			<%-- 
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">昵称:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${reList[0]['nickname']}"placeholder="昵称" id="changeprice1" name="changeprice1">
				</div>
			</div> --%>
				...
				<div class="formControls col-xs-8 col-sm-9">
					<div class="uploader-thum-container">
						...
						<input type="file" id="fileimg" /> <input type="hidden"
							name="imgname" id="imges"  value="${reList[0]['img']}" />
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${reList[0]['name']}"placeholder="礼物名称" id="changeprice1" name="changeprice1">
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${reList[0]['price']}"placeholder="礼物价格" id="changeprice2" name="changeprice2">
				</div>
			</div>
...
function go(id){
	...
	$.ajax({
		type:'POST',
		url: '<%=path%>/ar?a=A-boss-mod&b=dashang_search_bianji&p2='+id,
		data:{imges:$("#imges").val(),changeprice1:$("#changeprice1").val(),changeprice2:$("#changeprice2").val()},
		success: function(data){
