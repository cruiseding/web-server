...
if(request.getSession().getAttribute("admin")!=null&&!"".equals(request.getSession().getAttribute("admin").toString())){
	...
	job=request.getSession().getAttribute("job")+"";
 }else{
...
<aside class="Hui-aside">
	...
	<%-- <% if(b.contains("用户管理")){%> --%>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=cash_withdrawal&p2=1&p3=&p4=&p5=tojsp&p6=&p7=0&p8=0&nc=&p10=" data-title="提现明细" href="javascript:void(0)">趣豆收益提现</a></li>
					<li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=cash_withdrawal_fx&p2=1&p3=&p4=&p5=tojsp&p6=&p7=0&p8=0&nc=&p10=" data-title="提现明细" href="javascript:void(0)">分享收益提现</a></li>
					<%-- <li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=cash_withdrawal&p2=1&p3=&p4=&p5=tojsp&p6=&p7=0&p8=0&nc=&p10=" data-title="提现明细" href="javascript:void(0)">渠道商提现明细</a></li> --%>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=certification_manage&p2=1&p3=tojsp&p4=&p5=&p6=&p7=&p8=" data-title="实名认证" href="javascript:void(0)">实名认证</a></li>
				</ul>
			</dd>
		</dl>
		<% } %>
		<% if(b.contains("鉴黄管理")){%>
		<dl id="menu-product">
			<dt><i class="Hui-iconfont">&#xe725;</i> 鉴黄管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=jianhuang_set" data-title="鉴黄设置" href="javascript:void(0)">鉴黄设置</a></li>
					<li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=jianhuang_list&p2=1&p3=tojsp&p4=&p5=&p6=&p7=&p8=" data-title="鉴黄列表" href="javascript:void(0)">鉴黄列表</a></li>
				</ul>
			</dd>
		</dl>
		<% } %>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
				  ...
				  <li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=service_search" data-title="客服信息" href="javascript:void(0)">客服信息</a></li> 
				</ul>
			</dd>
		</dl>
		<% } %>
		...
		<% if(b.contains("分销管理")){%>
		<dl id="menu-product">
			<dt><i class="Hui-iconfont">&#xe72d;</i> 分销列表<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>							
				  ...
				  <li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=fenxiao_liebiao&p2=1&p3=tojsp&p4=&p5=" data-title="分销列表" href="javascript:void(0)">分销列表</a></li> 
				</ul>
			</dd>
		</dl>
		<% } %>
		...
		<% if(b.contains("渠道商管理")){%>
		 <dl id="menu-product">
			<dt><i class="Hui-iconfont">&#xe725;</i> 渠道商管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					...
					<%-- <li><a data-href="<%=path%>/agent?p0=A-bigboss-search&p1=agentfencheng_set&p2=0&p4=&p3=tojsp" data-title="主播分成相关设置" href="javascript:void(0)">分成设置</a></li>  --%>
					<li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=agentist1&p2=0&p4=&p3=tojsp" data-title="渠道商列表" href="javascript:void(0)">渠道商列表</a></li>
					<li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=acash_withdrawal&p2=0&p4=&p3=tojsp" data-title="渠道商提现" href="javascript:void(0)">渠道商提现</a></li>
					<li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=agent_analyse&p2=1&p3=&p4=&p5=tojsp&p6=&p7=0" data-title="渠道商报表" href="javascript:void(0)">渠道商报表</a></li>
					<li><a data-href="<%=path%>/agent?p0=A-boss-search&p1=qds_search&p2=1&p3=tojsp&p4=&p5=&p6=&p7=&p8=" data-title="渠道商明细" href="javascript:void(0)">渠道商明细</a></li>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
				<li><a data-href="<%=path%>/ar?p0=A-boss-search&p1=log_search&p2=1&p3=tojsp&p4=&p5=&p6=&p7=" data-title="日志查询" href="javascript:void(0)">日志查询</a></li>
				</ul>
			</dd>
		</dl>
		<%  } %> 
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="欢迎页面" data-href="http://120.27.98.128:9810/uiface/welcome.html">欢迎页面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="http://120.27.98.128:9810/uiface/welcome.html"></iframe>
	</div>
</div>
</section>
