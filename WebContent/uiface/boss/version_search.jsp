...
<body>
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
		    <a href="javascript:;" onclick="proj_edit('版本更新','<%=basePath%>/uiface/boss/version_update.jsp','600','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 版本更新</a>
...
function fresh_page(pageIndex) {
	...
	$.ajax({
		...
		url:"<%=path%>/ar?p0=A-boss-search&p1=version_search&p2="+pageIndex+"&p3=tojson&p4="+startdate+"&p5="+enddate,
