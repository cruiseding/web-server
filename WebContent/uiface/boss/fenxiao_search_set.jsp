...
<body>
	<article class="page-container">
		<form action="<%=path%>/ar?a=A-boss-mod&b=mod_fenxiao&c=0" method="post"
			class="form form-horizontal" id="form-article-add" name="ThisForm">
		
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">分销奖励金额(邀请男用户):</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['mon_onefee']}" placeholder="请输入内容" 
						id="onefee" name="onefee">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">vip充值提成:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['pay_v_onefee']}" placeholder="请输入内容" 
						id="twofee" name="twofee">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">趣豆充值提成:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['pay_onefee']}" placeholder="请输入内容" 
						id="threefee" name="threefee">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">分销收入提成:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['cash_onefee']}" placeholder="请输入内容" 
						id="fourfee" name="fourfee">
				</div>
			</div>
			
			<%-- <div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">图片收入提成:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['photo_onefee']}" placeholder="请输入内容" 
						id="fivefee" name="fivefee">
				</div>
			</div> --%>
