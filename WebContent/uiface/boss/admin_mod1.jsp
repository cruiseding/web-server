...
<body>
	<article class="page-container">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['username']}" placeholder="请输入内容" 
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['password']}" placeholder="请输入内容" 
...
function baocun(){
	...
	if(a.length<6||b.length<6){
		...
		$.ajax({ 
			url :"<%=path%>/ar?a=A-boss-mod&b=admin_mod1&mode2=${reList[0].id}&c="+a+"&d="+b+"&e="+cbValue+"&f="+abcd, 
			type : 'post', 
			cache : false, 
			contentType : false, 
			processData : false, 
