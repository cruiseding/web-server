			...
			<div class="row cl" >
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['password']}" placeholder="" 
						id="changeprice1" name="changeprice1" readonly="readonly" >
				</div>
			</div>
...
function baocun(){
    ...
    $.ajax({ 
		url :"<%=path%>/ar?a=A-boss-mod&b=admin_mod1&mode2=${reList[0].id}&c="+a+"&d="+b+"&e="+cbValue, 
		type : 'post', 
		cache : false, 
		contentType : false, 
		processData : false, 
