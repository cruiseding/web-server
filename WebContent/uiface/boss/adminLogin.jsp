...
<title>趣缘商家管理后台</title>

<link href="<%=path %>/boss/admin_login.css" rel="stylesheet" type="text/css" />
...
<div class="admin_login_wrap">
    ...
    <div class="adming_login_border">
        <div class="admin_input">
			<form action="<%=path%>/ar?mode1=A-boss-search&mode2=admin_logins&sellerid=${account}&p=&p4=&p5=" method="post" name="ThisForm">
                ...
                <ul class="admin_items">
                    ...
                    <li>
                        ...
                        <!-- <input type="hidden" id="text1" name="text1" placeholder=""  required size="40" class="admin_input_style" />
                        <input type="hidden" id="text2" name="text2" placeholder=""  required size="40" class="admin_input_style" /> -->
                    <li>
