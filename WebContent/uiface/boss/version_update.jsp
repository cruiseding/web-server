...
<body>
	<article class="page-container">
		<form  
			class="form form-horizontal" id="form-article-add" name="ThisForm">  <%-- action="<%=path%>/ar?a=A-boss-add&b=photo_add" method="post" --%>
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">最新版本号：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						 placeholder="最新版本号"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" 
						placeholder="下载地址" id="changeprice3" name="changeprice3">
				</div>
			</div>
...
function go(){
	...
	$.ajax({
		type:'POST',
		url: '<%=path%>/ar?a=A-boss-add&b=version_update',
		data:{changeprice1:$("#changeprice1").val(),changeprice2:$("#changeprice2").val(),changeprice3:$("#changeprice3").val()},
		success: function(data){
