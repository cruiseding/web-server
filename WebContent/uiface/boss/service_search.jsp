...
<body>
	<nav class="breadcrumb">
		...
		客服管理
		<span class="c-gray en">&gt;</span> 客服信息
		...
		<div style="height:20px">
			...
			<div class="dataTables_wrapper">
						...
						<c:forEach var="map" items="${reList}" varStatus="status">
							...
							<!-- 序号、用户ID、充值类型、充值金额、爱豆数量、充值状态、时间 -->
								...
								<a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/ar?p0=A-boss-mod&p1=service_mod&p2=${map['id']}','','600','510')"
				...
				<div class="dataTables_info" id="DataTables_Table_0_info"
					...
					显示 <span id="pagefirst">1</span> 到 <span id="pagelast">2</span>
					，共 <span id="total">2</span>条
				</div>
				<div class="dataTables_paginate paging_simple_numbers"
					...
					<a class="paginate_button previous disabled"
						...
						data-dt-idx="1" tabindex="0"><span id="currentpage">1</span></a></span>
