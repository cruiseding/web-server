...
//		url = "jdbc:mysql://121.42.136.119:3306/" + dbName + "?useUnicode=true&characterEncoding=utf-8";
		url = "jdbc:mysql://" + JyGlobalConstant.getDbBaseAddr() + "/" + dbName
	...
	private void init() {
		...
		poolProps.setMaxActive(200); // 最大200个连接
...
//			public void run() {
//				while(true) {
//					System.out.println("连接池报告：当前活跃数" + ds.getNumActive() + ", 当前闲置数" + ds.getNumIdle() + ", 当前等待数" + ds.getWaitCount());
//					try {
//						Thread.sleep(1000);
