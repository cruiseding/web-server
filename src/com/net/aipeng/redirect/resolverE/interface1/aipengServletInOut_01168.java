...
@WebServlet("/uiface/ar")
public class aipengServletInOut_01168 extends HttpServlet {

	private static final long serialVersionUID = -1204545408335287565L;

	public aipengServletInOut_01168() {
		super();
	}
...
//		}
		...
		try {
			switch (arg[0]) {
				case "A-boss-add":
					inOutFace = new aipengInoutBoss_01168(arg, request, response);
					inOutFace.addface();
					break;
				case "A-boss-mod":
					inOutFace = new aipengInoutBoss_01168(arg, request, response);
		...
		System.out.println("连接池获取连接时间:" + (after - before)/1000 + "秒");
	}
