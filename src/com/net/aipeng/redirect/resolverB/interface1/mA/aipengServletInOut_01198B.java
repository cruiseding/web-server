...
@WebServlet("/uiface/memberB01198")
public class aipengServletInOut_01198B extends HttpServlet {

	private static final long serialVersionUID = -1204545408335287565L;

	public aipengServletInOut_01198B() {
		super();
	}
...
//		}
		...
		try {
			...
			case "A-user-add":
				inOutFace = new aipengInoutUser_01198B(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
				inOutFace = new aipengInoutUser_01198B(arg, request, response);
