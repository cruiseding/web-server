...
public class BaseSample {
	...
	protected static String accessKeyId = "LTAIHDhPogXoeW6z";
	protected static String accessKeySecret = "NrJBb3Zpcvas9NsHUvQrYNaFy3bkDJ";
...
//            regionId = "cn-shanghai";	//properties.getProperty("regionId");
	...
	// System.out.println("accessKeyId: "+accessKeyId+", accessKeySecret:
	// "+accessKeySecret+",regionId: "+regionId);
//        } catch(IOException e) {
//            e.printStackTrace();
//        }
