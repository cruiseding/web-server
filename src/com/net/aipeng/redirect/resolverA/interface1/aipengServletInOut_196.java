...
@WebServlet("/uiface/member196")
public class aipengServletInOut_196 extends HttpServlet {

	private static final long serialVersionUID = -1204545408335287565L;

	public aipengServletInOut_196() {
		super();
	}
...
//		arg = JsonUtil.jsonReceive(request);
		...
		try {
			...
			case "A-user-add":
				inOutFace = new aipengInoutUser_196(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
				inOutFace = new aipengInoutUser_196(arg, request, response);
