...
import com.net.aipeng.redirect.resolverD.interface4.pay.util.http.HttpClientConnectionManager;

//import com.net.feimiaoquan.classroot.interface4.JyLogDetect;
//import com.net.feimiaoquan.redirect.resolverC.interface4.pay.util.http.HttpClientConnectionManager;
//
...
public class GetWxOrderno {
	...
	public static String getPayNo(String url, String xmlParam) {
		...
		try {
			...
			log.send("01115", "getPayNo=", jsonStr);
			...
			e.printStackTrace();
			log.send("01115", "Exception", e.toString());
		}
		return prepay_id;
	}
