...
public class WXOrdercreate {

	public static String order_creat(String money, String out_trade_no, String type, HttpServletRequest request,
		...
		String GZHID = "wxa7cf2d506df9fddf";
		String GZHSecret = "dd132668ab8f6fd2ed9e5d4a234ece77";
		String SHHID = "1515345071";
		String SHHKEY = "OB3rSpltQMkiXLs2fBbLIobdcmDIgpsu";
		// String notify_url="http://hasdwq.cn/wxpay/notify";
		String notify_url = "http://app.quyuanapp.com/wxpay/notify";
...
//		}
		...
		String xml = "<xml>" + "<appid><![CDATA[" + GZHID + "]]></appid>" +
		// "<attach><![CDATA["+sellerid+","+dbname+"]]></attach>"+
				"<body><![CDATA[" + type + "]]></body>" + "<mch_id><![CDATA[" + SHHID + "]]></mch_id>"
				+ "<nonce_str><![CDATA[" + nonce_str + "]]></nonce_str>" + "<notify_url><![CDATA[" + notify_url
				+ "]]></notify_url>" +
				// "<openid><![CDATA["+openid+"]]></openid>"+
				"<out_trade_no><![CDATA[" + out_trade_no + "]]></out_trade_no>" + "<spbill_create_ip><![CDATA["
				+ spbill_create_ip + "]]></spbill_create_ip>" + "<sign><![CDATA[" + sign + "]]></sign>"
				+ "<total_fee><![CDATA[" + finalmoney + "]]></total_fee>" + "<trade_type><![CDATA[" + trade_type
				+ "]]></trade_type>" + "</xml>";
