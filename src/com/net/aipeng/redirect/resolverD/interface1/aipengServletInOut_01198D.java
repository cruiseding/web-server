...
@WebServlet("/uiface/memberD01198")
public class aipengServletInOut_01198D extends HttpServlet {

	private static final long serialVersionUID = -1204545408335287565L;

	public aipengServletInOut_01198D() {
		super();
	}
...
//		arg = JsonUtil.jsonReceive(request);
		...
		try {
			...
			case "A-user-add":
				inOutFace = new aipengInoutUser_01198D(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
				inOutFace = new aipengInoutUser_01198D(arg, request, response);
