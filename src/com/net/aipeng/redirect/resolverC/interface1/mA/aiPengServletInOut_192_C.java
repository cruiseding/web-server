...
@WebServlet("/uiface/aipengC")
public class aiPengServletInOut_192_C extends HttpServlet {

	private static final long serialVersionUID = -1204545408335287565L;

	public aiPengServletInOut_192_C() {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.send(DataType.specialType, "01192", "yuedanServletInOut_01192_arg:", arg);
...
//			}
		...
		try {
			...
			case "A-user-add":
				inOutFace = new aiPengInoutUser_192_C(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
				inOutFace = new aiPengInoutUser_192_C(arg, request, response);
