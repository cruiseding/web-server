...
@WebServlet("/uiface/memberC01215")
public class aipengServletInOut_C_01215 extends HttpServlet {

	private static final long serialVersionUID = -1204545408335287565L;

	public aipengServletInOut_C_01215() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.send(DataType.specialType, "01215_____", "vliaoServletInOut_01215_arg:", arg);
		...
		try {
			...
			case "A-user-add":
				log.send(DataType.specialType, "01215_____", "---A-user-add---", arg);
				inOutFace = new aipengInoutUser_C_01215(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
				log.send(DataType.specialType, "01215_____", "---A-user-mod---", arg);
				inOutFace = new aipengInoutUser_C_01215(arg, request, response);
				inOutFace.modface();
				break;
			case "A-user-search":
				log.send(DataType.specialType, "01215_____", "---A-user-search---", arg);
				inOutFace = new aipengInoutUser_C_01215(arg, request, response);
				inOutFace.searchface();
				break;
			case "A-user-delete":
				log.send(DataType.specialType, "01215_____", "---A-user-delete---", arg);
				inOutFace = new aipengInoutUser_C_01215(arg, request, response);
