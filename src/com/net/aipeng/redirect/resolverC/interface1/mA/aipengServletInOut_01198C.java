...
@WebServlet("/uiface/memberC98")
public class aipengServletInOut_01198C extends HttpServlet {

	private static final long serialVersionUID = -1204545408335287565L;

	public aipengServletInOut_01198C() {
		super();
	}
...
//		arg = JsonUtil.jsonReceive(request);
		...
		try {
			switch (arg[0]) {
				case "A-user-add":
					inOutFace = new aipengInoutUser_01198C(arg, request, response);
					inOutFace.addface();
					break;
				case "A-user-mod":
					inOutFace = new aipengInoutUser_01198C(arg, request, response);
