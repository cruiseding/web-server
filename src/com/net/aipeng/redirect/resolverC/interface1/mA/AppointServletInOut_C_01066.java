...
@WebServlet("/uiface/appoint")
public class AppointServletInOut_C_01066 extends HttpServlet {

	private static final long serialVersionUID = -1204545408335287565L;

	public AppointServletInOut_C_01066() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "A-user-add":
				...
				inOutFace = new AppointInoutUser_C_01066(arg, request, response);
				inOutFace.addface();
				break;
			case "A-user-mod":
